...
<head>
    ...
    <title>Domain Registration | CK Editz</title>
...
<body ng-controller="MainController">
    ...
    <!-- ========================================== -->
    <!-- DOMAIN REGISTRATION DEDICATED CONTENT      -->
    <!-- ========================================== -->
        ...
        <div class="container mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center relative z-10">
            <div data-aos="fade-up">
                ...
                <h1 class="text-5xl md:text-6xl font-display font-extrabold text-white leading-tight mb-6">
                    Claim Your <span class="animated-text">Digital Identity</span>
                </h1>
                <p class="text-lg text-white/70 mb-10 max-w-xl font-medium">
                    Your domain name is your address on the internet. We help you find, secure, and register the perfect domain name that builds trust and matches your brand identity perfectly.
                </p>
                <a href="#cta" class="inline-flex items-center gap-2 btn-magic text-white px-8 py-4 rounded-full font-bold text-sm uppercase tracking-wider">
                    Find My Domain <i class="fas fa-globe"></i>
                </a>
            </div>
            <div class="relative hidden md:block" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="300">
                ...
                <img src="https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?q=80&w=2072&auto=format&fit=crop" alt="Domain Registration" class="relative w-full h-[450px] object-cover rounded-[3rem] border-4 border-white/10">
            </div>
        </div>
    </section>
    ...
    <section class="py-24 bg-ck-bg">
        <div class="container mx-auto px-6">
            <div class="text-center mb-16" data-aos="fade-up">
                <span class="text-ck-purple font-bold uppercase tracking-[0.3em] text-xs">Why You Need a Domain</span>
                <h2 class="text-4xl md:text-5xl font-display mt-4 text-ck-dark font-extrabold">The Power of a <span class="animated-text">Custom Domain</span></h2>
                <p class="text-ck-dark/60 mt-4 max-w-2xl mx-auto font-medium">Don't use a free, unprofessional extension. A custom domain is the foundation of your digital brand.</p>
            </div>
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="bg-white p-8 rounded-3xl shadow-sm border border-purple-100 card-3d" data-aos="fade-up">
                    ...
                    <h3 class="text-xl font-display font-bold text-ck-dark mb-3">Professional Image</h3>
                    <p class="text-ck-dark/60 font-medium">Having a custom domain (yourbrand.com) shows customers you are a legitimate, established business.</p>
                </div>
                <div class="bg-white p-8 rounded-3xl shadow-sm border border-pink-100 card-3d" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <h3 class="text-xl font-display font-bold text-ck-dark mb-3">Brand Protection</h3>
                    <p class="text-ck-dark/60 font-medium">Securing your domain prevents competitors or scammers from registering it and stealing your traffic.</p>
                </div>
                <div class="bg-white p-8 rounded-3xl shadow-sm border border-cyan-100 card-3d" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <h3 class="text-xl font-display font-bold text-ck-dark mb-3">Custom Emails</h3>
                    <p class="text-ck-dark/60 font-medium">Send emails from name@yourbrand.com instead of a generic Gmail address to build trust.</p>
                </div>
                <div class="bg-white p-8 rounded-3xl shadow-sm border border-purple-100 card-3d" data-aos="fade-up" data-aos-delay="300">
                    <div class="icon-box w-16 h-16 bg-purple-50 rounded-2xl flex items-center justify-center text-3xl mb-6 text-ck-purple">
                        <i class="fas fa-search"></i>
                    </div>
                    <h3 class="text-xl font-display font-bold text-ck-dark mb-3">SEO Boost</h3>
                    <p class="text-ck-dark/60 font-medium">Search engines favor custom domains. A good name helps you rank higher in search results.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 bg-white">
        <div class="container mx-auto px-6">
            <div class="text-center mb-16" data-aos="fade-up">
                <span class="text-ck-cyan font-bold uppercase tracking-[0.3em] text-xs">Domain Extensions</span>
                <h2 class="text-4xl md:text-5xl font-display mt-4 text-ck-dark font-extrabold">Extensions <span class="animated-text">We Provide</span></h2>
                <p class="text-ck-dark/60 mt-4 max-w-2xl mx-auto font-medium">We help you choose the right extension (TLD) based on your business type and location.</p>
            </div>
            <div class="grid md:grid-cols-2 gap-8">
                <div class="flex items-start gap-6 bg-ck-bg p-8 rounded-3xl border border-purple-100" data-aos="fade-right">
                    <div class="w-16 h-16 bg-gradient-to-br from-ck-purple to-ck-pink rounded-2xl flex items-center justify-center text-2xl text-white flex-shrink-0 shadow-lg"><i class="fas fa-globe-americas"></i></div>
                    <div>
                        <h3 class="text-xl font-display font-bold text-ck-dark mb-2">.com (Commercial)</h3>
                        <p class="text-ck-dark/60 font-medium">The gold standard. Best for businesses aiming for a global or international audience.</p>
                    </div>
                </div>
                <div class="flex items-start gap-6 bg-ck-bg p-8 rounded-3xl border border-pink-100" data-aos="fade-left">
                    <div class="w-16 h-16 bg-gradient-to-br from-ck-pink to-ck-cyan rounded-2xl flex items-center justify-center text-2xl text-white flex-shrink-0 shadow-lg"><i class="fas fa-map-marker-alt"></i></div>
                    <div>
                        <h3 class="text-xl font-display font-bold text-ck-dark mb-2">.in & .co.in (India)</h3>
                        <p class="text-ck-dark/60 font-medium">Perfect for businesses targeting the Indian market and local customers.</p>
                    </div>
                </div>
                <div class="flex items-start gap-6 bg-ck-bg p-8 rounded-3xl border border-cyan-100" data-aos="fade-right">
                    <div class="w-16 h-16 bg-gradient-to-br from-ck-cyan to-ck-purple rounded-2xl flex items-center justify-center text-2xl text-white flex-shrink-0 shadow-lg"><i class="fas fa-network-wired"></i></div>
                    <div>
                        <h3 class="text-xl font-display font-bold text-ck-dark mb-2">.org (Organization)</h3>
                        <p class="text-ck-dark/60 font-medium">The trusted choice for NGOs, non-profits, and community-driven platforms.</p>
                    </div>
                </div>
                <div class="flex items-start gap-6 bg-ck-bg p-8 rounded-3xl border border-purple-100" data-aos="fade-left">
                    ...
                    <div>
                        <h3 class="text-xl font-display font-bold text-ck-dark mb-2">.net & .store</h3>
                        <p class="text-ck-dark/60 font-medium">Great for tech companies, network providers, and e-commerce storefronts.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Process for Domain Registration -->
    <section class="py-24 bg-ck-bg">
        <div class="container mx-auto px-6">
            <div class="text-center mb-16" data-aos="fade-up">
                <span class="text-ck-purple font-bold uppercase tracking-[0.3em] text-xs">Our Strategy</span>
                <h2 class="text-4xl md:text-5xl font-display mt-4 text-ck-dark font-extrabold">How We <span class="animated-text">Register Domains</span></h2>
            </div>
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="text-center p-6 bg-white rounded-3xl border border-purple-100 shadow-sm" data-aos="fade-up">
                    ...
                    <h4 class="text-lg font-display font-bold mb-2 text-ck-dark">Search & Suggest</h4>
                    <p class="text-ck-dark/60 text-sm font-medium">We brainstorm and search for the best, most brandable domain names available for you.</p>
                </div>
                <div class="text-center p-6 bg-white rounded-3xl border border-pink-100 shadow-sm" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <h4 class="text-lg font-display font-bold mb-2 text-ck-dark">Secure Checkout</h4>
                    <p class="text-ck-dark/60 text-sm font-medium">We handle the registration process securely, ensuring you have full legal ownership.</p>
                </div>
                <div class="text-center p-6 bg-white rounded-3xl border border-cyan-100 shadow-sm" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <h4 class="text-lg font-display font-bold mb-2 text-ck-dark">DNS Configuration</h4>
                    <p class="text-ck-dark/60 text-sm font-medium">We configure the DNS settings to connect your domain to your website or email host.</p>
                </div>
                <div class="text-center p-6 bg-white rounded-3xl border border-purple-100 shadow-sm" data-aos="fade-up" data-aos-delay="600">
                    ...
                    <h4 class="text-lg font-display font-bold mb-2 text-ck-dark">Auto-Renewal Setup</h4>
                    <p class="text-ck-dark/60 text-sm font-medium">We set up auto-renewal so you never accidentally lose your domain name in the future.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="cta" class="py-20 bg-ck-dark relative overflow-hidden">
        ...
        <div class="container mx-auto px-6 text-center relative z-10" data-aos="zoom-in">
            <h2 class="text-3xl md:text-5xl font-display font-extrabold text-white mb-6">Ready to Secure Your <span class="animated-text">Domain Name?</span></h2>
            <p class="text-white/70 max-w-2xl mx-auto mb-8 text-lg font-medium">Don't wait until someone else takes your perfect domain. Let us secure your digital identity today.</p>
    ...
    <!-- ========================================== -->
    <!-- END DOMAIN REGISTRATION CONTENT            -->
    <!-- ========================================== -->
