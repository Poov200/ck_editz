...
<head>
    ...
    <title>Google Ads (PPC) | CK Editz</title>
...
<body ng-controller="MainController">
    ...
    <!-- ========================================== -->
    <!-- GOOGLE ADS DEDICATED PAGE CONTENT          -->
    <!-- ========================================== -->
        ...
        <div class="container mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center relative z-10">
            ...
            <div>
                ...
                <h1 class="text-5xl md:text-6xl font-display font-extrabold text-white leading-tight mb-6">
                    Capture High-Intent Users with <span class="animated-text">Google Ads</span>
                </h1>
                <p class="text-lg text-white/70 mb-10 max-w-xl font-medium">
                    Reach customers exactly when they are searching for your products or services. We create highly optimized PPC campaigns that drive instant traffic and measurable ROI.
                </p>
            ...
            <div class="relative hidden md:block">
                ...
                <img src="https://images.unsplash.com/photo-1573164713988-8665fc963095?q=80&w=2069&auto=format&fit=crop" alt="Google Ads" class="relative w-full h-[450px] object-cover rounded-[3rem] border-4 border-white/10">
            </div>
        </div>
    </section>
    ...
    <section class="py-24 bg-ck-bg">
        <div class="container mx-auto px-6">
            <div class="text-center mb-16" data-aos="fade-up">
                <span class="text-ck-cyan font-bold uppercase tracking-[0.3em] text-xs">Why Choose Google Ads?</span>
                <h2 class="text-4xl md:text-5xl font-display mt-4 text-ck-dark font-extrabold">Benefits of <span class="animated-text">Advertising on Google</span></h2>
                <p class="text-ck-dark/60 mt-4 max-w-2xl mx-auto font-medium">Google Ads is the most effective platform for capturing users actively looking to buy.</p>
            </div>
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="bg-white p-8 rounded-3xl shadow-sm border border-cyan-100 card-3d" data-aos="fade-up">
                    ...
                    <h3 class="text-xl font-display font-bold text-ck-dark mb-3">High-Intent Targeting</h3>
                    <p class="text-ck-dark/60 font-medium">Reach people who are actively searching for exactly what you offer. High intent means higher conversion rates.</p>
                </div>
                <div class="bg-white p-8 rounded-3xl shadow-sm border border-cyan-100 card-3d" data-aos="fade-up" data-aos-delay="100">
                    <div class="icon-box w-16 h-16 bg-purple-50 rounded-2xl flex items-center justify-center text-3xl mb-6 text-ck-purple">
                        <i class="fas fa-bolt"></i>
                    </div>
                    <h3 class="text-xl font-display font-bold text-ck-dark mb-3">Instant Traffic</h3>
                    <p class="text-ck-dark/60 font-medium">Skip the SEO waiting line. Appear at the top of Google search results on day one of your campaign launch.</p>
                </div>
                <div class="bg-white p-8 rounded-3xl shadow-sm border border-cyan-100 card-3d" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <h3 class="text-xl font-display font-bold text-ck-dark mb-3">Budget Control</h3>
                    <p class="text-ck-dark/60 font-medium">You only pay when someone actually clicks on your ad. Set your own daily budgets and max bids for complete control.</p>
                </div>
                <div class="bg-white p-8 rounded-3xl shadow-sm border border-cyan-100 card-3d" data-aos="fade-up" data-aos-delay="300">
                    <div class="icon-box w-16 h-16 bg-cyan-50 rounded-2xl flex items-center justify-center text-3xl mb-6 text-ck-cyan">
                        <i class="fas fa-globe"></i>
                    </div>
                    <h3 class="text-xl font-display font-bold text-ck-dark mb-3">Massive Reach</h3>
                    <p class="text-ck-dark/60 font-medium">Leverage the Google Search Network and partner websites to reach over 90% of global internet users.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 bg-white">
        <div class="container mx-auto px-6">
            <div class="text-center mb-16" data-aos="fade-up">
                <span class="text-ck-purple font-bold uppercase tracking-[0.3em] text-xs">Campaign Types</span>
                <h2 class="text-4xl md:text-5xl font-display mt-4 text-ck-dark font-extrabold">Types of Ads <span class="animated-text">We Run</span></h2>
                <p class="text-ck-dark/60 mt-4 max-w-2xl mx-auto font-medium">We create custom Google Ads campaigns tailored to your specific business goals.</p>
            </div>
            <div class="grid md:grid-cols-2 gap-8">
                <div class="flex items-start gap-6 bg-ck-bg p-8 rounded-3xl border border-cyan-100" data-aos="fade-right">
                    <div class="w-16 h-16 bg-gradient-to-br from-ck-cyan to-ck-purple rounded-2xl flex items-center justify-center text-2xl text-white flex-shrink-0 shadow-lg"><i class="fas fa-keyboard"></i></div>
                    <div>
                        <h3 class="text-xl font-display font-bold text-ck-dark mb-2">Search Ads (PPC)</h3>
                        <p class="text-ck-dark/60 font-medium">Text-based ads that appear at the top of Google search results when users type in your targeted keywords.</p>
                    </div>
                </div>
                <div class="flex items-start gap-6 bg-ck-bg p-8 rounded-3xl border border-cyan-100" data-aos="fade-left">
                    <div class="w-16 h-16 bg-gradient-to-br from-ck-purple to-ck-pink rounded-2xl flex items-center justify-center text-2xl text-white flex-shrink-0 shadow-lg"><i class="fas fa-desktop"></i></div>
                    <div>
                        <h3 class="text-xl font-display font-bold text-ck-dark mb-2">Display Ads</h3>
                        <p class="text-ck-dark/60 font-medium">Visually engaging banner ads placed across millions of websites, apps, and Google-owned platforms.</p>
                    </div>
                </div>
                <div class="flex items-start gap-6 bg-ck-bg p-8 rounded-3xl border border-cyan-100" data-aos="fade-right">
                    ...
                    <div>
                        <h3 class="text-xl font-display font-bold text-ck-dark mb-2">YouTube Ads</h3>
                        <p class="text-ck-dark/60 font-medium">Video ad campaigns that play before or during YouTube videos, building massive brand awareness.</p>
                    </div>
                </div>
                <div class="flex items-start gap-6 bg-ck-bg p-8 rounded-3xl border border-cyan-100" data-aos="fade-left">
                    <div class="w-16 h-16 bg-gradient-to-br from-ck-cyan to-ck-purple rounded-2xl flex items-center justify-center text-2xl text-white flex-shrink-0 shadow-lg"><i class="fas fa-shopping-cart"></i></div>
                    <div>
                        <h3 class="text-xl font-display font-bold text-ck-dark mb-2">Shopping Ads</h3>
                        <p class="text-ck-dark/60 font-medium">Showcase your product images, prices, and store name directly in Google's Shopping tab and Search.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-24 bg-ck-bg">
        <div class="container mx-auto px-6">
            <div class="text-center mb-16" data-aos="fade-up">
                ...
                <h2 class="text-4xl md:text-5xl font-display mt-4 text-ck-dark font-extrabold">How We Run <span class="animated-text">Google Ads</span></h2>
            </div>
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="text-center p-6 bg-white rounded-3xl border border-cyan-100 shadow-sm" data-aos="fade-up">
                    ...
                    <h4 class="text-lg font-display font-bold mb-2 text-ck-dark">Keyword Research</h4>
                    <p class="text-ck-dark/60 text-sm font-medium">We find the most profitable, high-intent search terms for your business and industry.</p>
                </div>
                <div class="text-center p-6 bg-white rounded-3xl border border-cyan-100 shadow-sm" data-aos="fade-up" data-aos-delay="200">
                    <div class="w-16 h-16 mx-auto bg-gradient-to-br from-ck-cyan to-ck-purple rounded-full flex items-center justify-center text-2xl mb-4 font-display font-bold text-white shadow-lg">2</div>
                    <h4 class="text-lg font-display font-bold mb-2 text-ck-dark">Ad Copywriting</h4>
                    <p class="text-ck-dark/60 text-sm font-medium">Our team crafts compelling ad copy that drives clicks and stands out from competitors.</p>
                </div>
                <div class="text-center p-6 bg-white rounded-3xl border border-cyan-100 shadow-sm" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <p class="text-ck-dark/60 text-sm font-medium">We implement conversion tracking to ensure every sale and lead is accurately measured.</p>
                </div>
                <div class="text-center p-6 bg-white rounded-3xl border border-cyan-100 shadow-sm" data-aos="fade-up" data-aos-delay="600">
                    ...
                    <p class="text-ck-dark/60 text-sm font-medium">We continuously monitor bids, A/B test ads, and remove waste to maximize your ROI.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="cta" class="py-20 bg-ck-dark relative overflow-hidden">
        ...
        <div class="container mx-auto px-6 text-center relative z-10" data-aos="zoom-in">
            <h2 class="text-3xl md:text-5xl font-display font-extrabold text-white mb-6">Ready to Scale with <span class="animated-text">Google Ads?</span></h2>
            <p class="text-white/70 max-w-2xl mx-auto mb-8 text-lg font-medium">Let our experts handle your Search, Display, and Shopping advertising. Get a free audit and strategy session today.</p>
